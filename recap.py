...
def process_chapter(chapter_url):
    ...
    for _ in range(15):
        try:
            res = requests.post(f"https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash-lite-preview:generateContent?key={GEMINI_API_KEYS[current_key]}", json=payload)
